...
Future<void> main(List<String> args) async {
  // ../../bin/cache/dart-sdk/bin/dart bin/test_runner.dart test -t module_uiscene_test_ios --local-engine ios_debug_sim_unopt_arm64 --local-engine-host host_debug --task-args destination=/Users/vashworth/Development/flutter/dev/integration_tests/ios_add2app_uiscene/temp --task-args include-local-only-tests --task args name=asdf --exit &> test.txt
  const String kDestination = 'destination';
  const String kRunLocal = 'include-local-only-tests';
  ...
  await task(() async {
    ...
    final bool includeLocalOnlyTests = argResults.flag(kRunLocal);
    ...
    try {
      ...
      await testWithNewIOSSimulator('TestAdd2AppSim', (String deviceId) async {
        ...
        final Scenarios scenarios = Scenarios(includeLocalOnlyTests: includeLocalOnlyTests);
...
class Scenarios {
  Scenarios({this.includeLocalOnlyTests = false});

  final bool includeLocalOnlyTests;
  ...
  late Map<String, Map<String, String>> scenarios = <String, Map<String, String>>{
    ...basicLifecycleEventScenarios,
    ...stateRestorationScenarios,
    if (includeLocalOnlyTests) ...localOnlyTests,
  };

  /// Local only tests are tests that will not pass in CI and must be run locally.
  late Map<String, Map<String, String>> localOnlyTests = <String, Map<String, String>>{
    ...deeplinkingScenarios,
  };

  late Map<String, Map<String, String>>
  basicLifecycleEventScenarios = <String, Map<String, String>>{
  ...
  late Map<String, Map<String, String>> deeplinkingScenarios = <String, Map<String, String>>{
    // When the root view controller is a FlutterViewController, it is expected that deeplinking should work.
    'AppNotMigrated-FlutterRootViewController': <String, String>{
      ...sharedDeeplinkingFiles,
      r'$TEMPLATE_DIR/native/Info-unmigrated-url-types.plist':
          r'$XCODE_PROJ_DIR/xcode_uikit_swift/Info.plist',
      r'$TEMPLATE_DIR/native/Main-FlutterViewController.storyboard':
          r'$XCODE_PROJ_DIR/xcode_uikit_swift/Base.lproj/Main.storyboard',
      r'$TEMPLATE_DIR/native/UITests-Deeplinking-FlutterRootViewController.swift':
          r'$XCODE_PROJ_DIR/xcode_uikit_swiftUITests/xcode_uikit_swiftUITests.swift',
    },
    // When the root view controller is a not FlutterViewController, it is expected that deeplinking will not work.
    'AppNotMigrated-NoFlutterRootViewController': <String, String>{
      ...sharedDeeplinkingFiles,
      r'$TEMPLATE_DIR/native/Info-unmigrated-url-types.plist':
          r'$XCODE_PROJ_DIR/xcode_uikit_swift/Info.plist',
      r'$TEMPLATE_DIR/native/UITests-Deeplinking-NoFlutterRootViewController.swift':
          r'$XCODE_PROJ_DIR/xcode_uikit_swiftUITests/xcode_uikit_swiftUITests.swift',
    },
    // When the root view controller is a FlutterViewController, it is expected that deeplinking should work.
    'AppMigrated-FlutterRootViewController': <String, String>{
      ...sharedDeeplinkingFiles,
      r'$TEMPLATE_DIR/native/Info-migrated-url-types.plist':
          r'$XCODE_PROJ_DIR/xcode_uikit_swift/Info.plist',
      r'$TEMPLATE_DIR/native/Main-FlutterViewController.storyboard':
          r'$XCODE_PROJ_DIR/xcode_uikit_swift/Base.lproj/Main.storyboard',
      r'$TEMPLATE_DIR/native/UITests-Deeplinking-FlutterRootViewController.swift':
    ...
    // When the root view controller is a not FlutterViewController, it is expected that deeplinking will not work.
    'AppMigrated-NoFlutterRootViewController': <String, String>{
      ...sharedDeeplinkingFiles,
      r'$TEMPLATE_DIR/native/Info-migrated-url-types.plist':
          r'$XCODE_PROJ_DIR/xcode_uikit_swift/Info.plist',
      r'$TEMPLATE_DIR/native/UITests-Deeplinking-NoFlutterRootViewController.swift':
  ...
  late Map<String, String> sharedDeeplinkingFiles = <String, String>{
    r'$TEMPLATE_DIR/flutterapp/lib/main-DeeplinkingTest': r'$APP_DIR/lib/main.dart',
    r'$TEMPLATE_DIR/native/project-AssociatedDomain.pbxproj':
        r'$XCODE_PROJ_DIR/xcode_uikit_swift.xcodeproj/project.pbxproj',
    r'$TEMPLATE_DIR/native/xcode_uikit_swift.entitlements':
        r'$XCODE_PROJ_DIR/xcode_uikit_swift/xcode_uikit_swift.entitlements',
    r'$TEMPLATE_DIR/native/AppDelegate-FlutterAppDelegate-FlutterEngine.swift':
        r'$XCODE_PROJ_DIR/xcode_uikit_swift/AppDelegate.swift',
    r'$TEMPLATE_DIR/native/SceneDelegate-FlutterSceneDelegate.swift':
        r'$XCODE_PROJ_DIR/xcode_uikit_swift/SceneDelegate.swift',
