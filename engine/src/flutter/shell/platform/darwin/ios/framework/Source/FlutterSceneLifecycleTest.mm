...
// - (void)testregisterFlutterEngine {
...
//   [delegate registerFlutterEngine:mockEngine scene:mockWindowScene];
...
//   [delegate registerFlutterEngine:mockEngine scene:mockWindowScene];
//   [delegate registerFlutterEngine:mockEngine scene:mockWindowScene];
//   [delegate registerFlutterEngine:mockEngine scene:mockWindowScene2];
//   XCTAssertEqual(delegate.engines.count, 1.0);
...
//   id mockWindowScene2 = OCMClassMock([UIWindowScene class]);
//   [delegate registerFlutterEngine:mockEngine2 scene:mockWindowScene2];
...
- (void)testUpdateEnginesInSceneRemovesEngineNotInScene {
  ...
  OCMVerify(times(1), [mockLifecycleDelegate registerFlutterEngine:mockEngine
...
- (void)testSceneDidDisconnect {
  ...
  [delegate registerFlutterEngine:mockEngine scene:mockScene];
  XCTAssertEqual(delegate.engines.count, 1.0);
